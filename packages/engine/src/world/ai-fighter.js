...
import { pickRegion, pickArchetypeForRegion } from "../identity.js";
...
export function createAIFighter(overrides = {}) {
  ...
  const region = overrides.region || pickRegion();
  ...
  return {
    ...
    region,
    archetype: overrides.archetype || pickArchetypeForRegion(region),
